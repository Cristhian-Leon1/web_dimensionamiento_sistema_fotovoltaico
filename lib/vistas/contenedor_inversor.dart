...
class ContenedorInversor extends StatelessWidget {
  const ContenedorInversor({super.key});
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: CustomTextField(
                                  labelText: 'Rendimiento de inversor:',
                                  hintText: '...',
                                  controller: providerCalculos.rendimientoInversorController
                                )
                              ),
                            ),
                            Expanded(
